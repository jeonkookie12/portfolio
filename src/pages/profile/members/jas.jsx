...
import jasImage from '../../../assets/members/jas.png';
import jasImage1 from '../../../assets/members/jas1.png';
...
const JasProfile = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:jadl59302@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
        ...
        <section className="px-8 sm:px-10 md:px-14 xl:px-28 py-16 mt-28">
          ...
          <div className="flex gap-10 justify-center flex-wrap">
            {["HTML", "CSS", "Bootstrap"].map((title, index) => {
              ...
              return (
              <div className="w-96 h-112 perspective cursor-pointer" onClick={() => toggleFlip(index)}>
