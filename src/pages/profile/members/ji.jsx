...
import profileImage from '/members/profile/ji1.png';
import aboutImage from '/members/profile/ji2.png';
...
import phpIcon from '../../../assets/skills-icons/php.png'; // Corrected icon name
import javascriptIcon from '../../../assets/skills-icons/javascript.png'; // Corrected icon name
...
const JiProfile = () => {
  ...
  const toggleFlip = (index) => {
    ...
    const handleSubmit = (e) => {
      ...
      window.location.href = `mailto:jiandeleon07@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    };
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-14 w-full max-w-7xl pt-12 pb-14">
            ...
            <div className="max-w-3xl text-center md:text-left">
              ...
              <p className="text-gray-400 text-xl md:text-2xl leading-relaxed">
                I am passionate about full-stack development, specializing in building efficient and innovative web applications.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-8 sm:px-10 md:px-14 xl:px-28 py-16 mt-28">
          ...
          <div className="flex gap-10 justify-center flex-wrap">
            {["Java", "PHP", "JavaScript"].map((title, index) => {
              const descriptions = {
                Java: "Java is a powerful, versatile programming language used for building server-side applications, Android apps, and more.",
                ...
                JavaScript: "JavaScript brings interactivity to web pages, enabling dynamic content, interactive forms, animations, and more.",
              };
              ...
              return (
                <div
                  key={index}
                  className="w-96 h-112 perspective cursor-pointer"
