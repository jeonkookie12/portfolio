...
import niksImage from '../../../assets/members/niks.png';
import niksImage1 from '../../../assets/members/niks1.png';
...
const NiksProfile = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:nicoleshaneadantis@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-14 w-full max-w-7xl pt-12 pb-14">
            ...
            <div className="max-w-3xl text-center md:text-left">
              ...
              <p className="text-gray-400 text-xl md:text-2xl leading-relaxed">
                Passionate Front-End Developer focused on creating visually appealing and user-friendly websites. Dedicated to continuous learning and crafting intuitive designs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-8 sm:px-10 md:px-14 xl:px-28 py-16 mt-28">
          ...
          <div className="flex gap-10 justify-center flex-wrap">
            {["HTML", "CSS", "Bootstrap"].map((title, index) => {
              const descriptions = {
                HTML: "HTML structures and presents content for the web, serving as the foundation of all websites.",
                CSS: "CSS styles and enhances the appearance of web pages, focusing on layout, colors, and fonts.",
                Bootstrap: "Bootstrap streamlines web design by providing responsive, mobile-first components and utilities.",
              };
