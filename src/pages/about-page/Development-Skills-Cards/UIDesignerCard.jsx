      ...
      <div className="relative flex flex-wrap md:flex-nowrap items-center justify-center min-h-[200px] px-4 md:px-4 lg:px-8">
        ...
        >
          <div className="w-20 h-20 bg-pink-500 rounded-full flex items-center justify-center">
            <img
              src="./skills-icons/UIDesigner-icon.png"
              alt="UI/UX Icon"
        ...
        <div
          className={`transition-all duration-1000 ease-in-out absolute hidden md:block ${
            isCardVisible
              ? "left-1/4 -translate-x-1/2 scale-75 delay-600"
              : "left-1/2 -translate-x-1/2 scale-110"
          }`}
        >
          <div className="w-28 h-28 md:w-32 md:h-32 bg-pink-500 rounded-full flex items-center justify-center">
            <img
              src="./skills-icons/UIDesigner-icon.png"
              alt="UI/UX Icon"
        ...
        >
          <div className="text-center mt-10 md:mt-0 w-full flex flex-col items-center">
            <p className="text-gray-200 text-lg mb-4 md:mb-8">Designing Tools</p>
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-3">
              {[
                { src: "skills-icons/figma.png", alt: "Figma" },
                { src: "skills-icons/canva.png", alt: "Canva" },
              ].map(({ src, alt }) => (
                <div
                  key={alt}
                  className="flex flex-col items-center w-[70px]"
                >
                  <img src={src} alt={alt} className="w-11 h-10 object-contain" />
